...
from modules.trainer_temporal import Trainer as TrainerTemporal
from models.blip import blip_decoder
from models.blip_temporal import blip_decoder as blip_decoder_temporal
...
def parse_agrs():
    ...
    parser.add_argument('--ann_path', type=str, default='data/mimic_cxr/mimic_annotation.json', help='the path to the directory containing the data.')
    parser.add_argument('--image_encoder', type=str, default='resnet101', choices=['cvt', 'resnet101'], help='input image encoder')
    ...
    parser.add_argument('--save_dir', type=str, default='results/output', help='the path to save the models.')
    ...
    parser.add_argument('--model_name', type=str, default='encoder_decoder', choices=['encoder_decoder', 'temporal_model'], help='training stage')
...
def main():
    ...
    if args.model_name=='temporal_model':
        model = blip_decoder_temporal(args, tokenizer, prompt=prompt_temp)
    else:
        model = blip_decoder(args, tokenizer, prompt=prompt_temp)
